 ...
 *
 * Author: Mihail Ivanchev (mihail12@gmail.com)
 * Date:   01/01/2015
 *
 * Original source file modified for the needs of the DJ Native Swing Clojure
 * wrapper.
 *
 * The initialization of the decorator now takes place after the construction
 * of the instance by explicitly calling an instance method for the class to be
 * extensible using proxy in Clojure. Protected methods made public for the same
 * reason.
 *
 * This file was relicensed for the dj-native-swing-clj project under the
 * following license with the permission of the original author.
 *
...
public static enum WebBrowserDecoratorComponentType {
  ...
  private static class NWebBrowserListener extends WebBrowserAdapter {
    ...
    public void locationChanged(WebBrowserNavigationEvent e) {
      ...
      DefaultWebBrowserDecorator decorator = getWebBrowserDecorator(webBrowser);
      if(e.isTopFrame()) {
    ...
    private DefaultWebBrowserDecorator getWebBrowserDecorator(JWebBrowser webBrowser) {
      try {
          Method method;
          method = JWebBrowser.class.getDeclaredMethod("getWebBrowserDecorator");
          method.setAccessible(true);
          return (DefaultWebBrowserDecorator) method.invoke(webBrowser);
   ...
   */
  public void addButtonBarComponents(WebBrowserButtonBar buttonBar) {
   ...
   */
  public void addLocationBarComponents(WebBrowserLocationBar locationBar) {
   ...
   */
  public void addMenuBarComponents(WebBrowserMenuBar menuBar) {
  ...
  private Component renderingComponent;
   ...
   */
  public Border getInnerAreaBorder() {
    Border border;
   ...
   */
  public void configureComponent(JComponent c, WebBrowserDecoratorComponentType componentType) {
